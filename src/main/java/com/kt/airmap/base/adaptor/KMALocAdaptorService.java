...
@Service
public class KMALocAdaptorService {

	private static final Logger logger = LoggerFactory.getLogger(KMALocAdaptorService.class);

	@Value("#{'${kma.loc.url}'.split(',')}")
	private List<String> urls;
	@Value("${kma.loc.contextPath}")
